...
function filterProducts(type = null) {
  ...
  if (f.keyword) {
    ...
    const synonymMap = {
      ...
      '入门': ['新手', '便宜', '性价比', '入门级', 'a7m4', '5d'],
      '专业': ['旗舰', '顶级', '商用', 'pro', 'r5', 'z8', 'a7r', 'gfx'],
      '便宜': ['入门', '性价比', '实惠', '5d', '二手'],
      '轻便': ['微单', 'mirrorless', '轻', '便携', 'pocket'],
      '高像素': ['6100万', '4500万', '一亿', '1.02亿', 'a7r', 'r5', 'gfx'],
      '运动': ['体育', '连拍', '追焦', '高速', 'z8', 'r5'],
      '婚礼': ['跟拍', '人像', '70-200', '2470', '活动'],
      '商业': ['广告', '产品', '中画幅', 'gfx', '灯光'],
    };
    // 展开同义词
    let searchTerms = [kw];
