...
const MockData = {
  ...
  products: [
    {
      ...
      price: { daily: 280, weekly: 1680, monthly: 5800, deposit: 8000 },
    ...
    },
    {
      ...
      price: { daily: 260, weekly: 1560, monthly: 5200, deposit: 7500 },
    ...
    },
    {
      ...
      price: { daily: 300, weekly: 1800, monthly: 6200, deposit: 8000 },
    ...
    },
    {
      ...
      price: { daily: 450, weekly: 2700, monthly: 9000, deposit: 15000 },
    ...
    },
    {
      ...
      price: { daily: 180, weekly: 1080, monthly: 3600, deposit: 5000 },
    ...
    },
    {
      ...
      price: { daily: 200, weekly: 1200, monthly: 4000, deposit: 5500 },
    ...
    },
    {
      ...
      price: { daily: 350, weekly: 2100, monthly: 7000, deposit: 10000 },
    ...
    },
    {
      ...
      price: { daily: 65, weekly: 390, monthly: 1300, deposit: 1500 },
    ...
    },
    {
      ...
      price: { daily: 150, weekly: 900, monthly: 3000, deposit: 4000 },
    ...
    },
    {
      ...
      price: { sell: 8500, original: 18999, deposit: 0 },
      images: ['5d4-1.webp', '5d4-2.webp', '5d4-3.webp'],
      desc: '自用佳能5D Mark IV，快门约45,000次，机身轻微使用痕迹，功能一切正常。配件齐全含原厂电池x2、充电器、肩带。因升级R5故出。',
    ...
    },
    {
      ...
      price: { sell: 6500, original: 12999, deposit: 0 },
      images: ['n2470-1.webp', 'n2470-2.webp'],
      desc: 'Nikon金圈24-70 F2.8 VR版，镜片通透无霉无划，变焦顺滑，VR防抖工作正常。带原厂遮光罩和前后盖。',
    ...
    },
    {
      ...
      price: { sell: 12800, original: 16999, deposit: 0 },
      images: ['a7m4-1.webp', 'a7m4-2.webp', 'a7m4-3.webp'],
      desc: '几乎全新的A7M4，快门仅12,000次左右。因想升级A7R5故转让。箱说全，带原厂电池x1、充电器、肩带，屏幕已贴膜。',
    ...
    },
    {
      ...
      price: { sell: 680, original: 1580, deposit: 0 },
      images: ['mf055-1.webp', 'mf055-2.webp'],
      desc: '曼富图经典款055系列三脚架，结实耐用，承重7kg。有正常使用痕迹，各锁紧旋钮工作正常。不含云台。',
      seller: { name: '二手达人', rating: 4.5, trades: 31, joined: '2025-01' },
      stock: 1, sold: 0, listedAt: '2026-06-08', location: '广州',
      reviews: []
    },
    {
      id: 15, category: 'video', brand: 'dj', condition: 'excellent', type: 'rent', rating: 90,
      ...
      price: { daily: 80, weekly: 480, monthly: 1600, deposit: 2000 },
    ...
    {
      id: 16, category: 'lighting', brand: 'godox', condition: 'like_new', type: 'rent', rating: 88,
      ...
      price: { daily: 160, weekly: 960, monthly: 3200, deposit: 4500 },
  ...
  orders: [
    { id: 'ORD-001', productId: 1, productName: 'Canon EOS R5', productImg: 'r5-1.webp', period: 'weekly', days: 7, price: 1680, deposit: 8000, status: 'renting', startDate: '2026-06-10', endDate: '2026-06-17', createdAt: '2026-06-08' },
    { id: 'ORD-002', productId: 5, productName: 'Canon RF 70-200mm F2.8 L', productImg: 'rf70200-1.webp', period: 'daily', days: 3, price: 540, deposit: 5000, status: 'completed', startDate: '2026-05-20', endDate: '2026-05-23', createdAt: '2026-05-18' },
    { id: 'ORD-003', productId: 3, productName: 'Sony A7R V', productImg: 'a7r5-1.webp', period: 'daily', days: 1, price: 300, deposit: 8000, status: 'completed', startDate: '2026-06-01', endDate: '2026-06-02', createdAt: '2026-05-30' },
    { id: 'ORD-004', productId: 11, productName: 'Canon 5D Mark IV (二手)', productImg: '5d4-1.webp', period: null, days: 0, price: 8500, deposit: 0, status: 'completed', startDate: null, endDate: null, createdAt: '2026-06-12', isPurchase: true },
  ],
